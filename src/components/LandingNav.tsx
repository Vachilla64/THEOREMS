...
export default function LandingNav() {
  return (
    <header className="absolute inset-x-0 top-6 z-50 ">
      <div className="glass mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 md:px-8  rounded-full overflow-hidden border-0">
        <Link
          to="/"
        ...
        <nav className="hidden items-center gap-8 text-md font-medium text-white/95 drop-shadow md:flex">
          <NavLink to="#about" className="transition hover:font-bold hover:-translate-y-1 hover:text-xl">
            About
          </NavLink>
          <a href="#product" className="transition hover:font-bold hover:-translate-y-1 hover:text-xl">
            Products & Services
          </a>
