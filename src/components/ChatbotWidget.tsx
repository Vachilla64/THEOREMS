      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-28 right-4 z-50 flex h-[35rem] md:h-[25.5rem] w-[calc(100vw-1.5rem)] max-w-sm flex-col overflow-hidden rounded-[2rem] border-0 glass border-white/40 bg-white/80 shadow-[0_8px_40px_rgba(0,0,0,0.15)] backdrop-blur-xl md:right-8"
          >
